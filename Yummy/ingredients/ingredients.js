...
let ingBtn = document.getElementById('ingredients')
    ...
    function homeFood() {
        ...
        for (let i = 0; i < catFinalApi.meals.length; i++) {
            ...
            <div class="position-relative overflow-hidden rounded-2" >
                <div class="card bg-transparent position-relative open-meal " data-id="${catFinalApi.meals[i].strIngredient}">
                <i class="fa-solid fa-drumstick-bite fa-4x w-25 text-center text-light"></i>
                    <div
                        ...
                        <p class="card-text">${catFinalApi.meals[i].strIngredient}</p>
                    </div>
                </div>
            </div>
        </div>
